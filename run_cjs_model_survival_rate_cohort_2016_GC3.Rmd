...
# save to csv
write.csv(result, "output/phi_age0_1_2016cohort_GC3.csv")
write.csv(result2, "output/phi_age0_2016cohort_GC3.csv")
```
...
# save to csv
write.csv(result, "output/phi_age0_1_oct_2016cohort_GC3.csv")
...
data <- d0 %>% 
  ...
  mutate(growth_cluster = as.numeric(ocluster_rename),
         ...
         age_at_mature2 = case_when(age_at_mature == "0" ~ "0",
                                    ...
                                    age_at_mature == ">3" ~ "2",
                                    TRUE ~ "nd")) %>% 
  filter(date >= as.Date('2016-10-01') & date < as.Date('2018-10-01')) %>%
...
# save to csv
write.csv(result, "output/phi_age1_2_oct_2016cohort_GC3.csv")
...
# save to csv
write.csv(result, "output/phi_age1_2_oct_2016cohort_without_GC3.csv")
